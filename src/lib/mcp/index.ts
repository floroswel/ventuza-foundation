...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Instrumente Suzeta pentru utilizatorul autentificat: profil propriu, contor mesaje/notificări necitite, listă notificări recente. Toate acțiunile rulează sub RLS ca utilizatorul curent și nu returnează date despre alți useri.",
