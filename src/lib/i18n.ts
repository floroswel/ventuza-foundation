...
const ro = {
  ...
  authErrors: {
    captchaMissing: "Completează verificarea anti-bot înainte de a continua.",
    captchaFailed: "Verificarea anti-bot a eșuat. Reîncearcă în câteva secunde.",
    rateLimited_one: "Prea multe încercări. Așteaptă {{s}} secundă și reîncearcă.",
    rateLimited_other: "Prea multe încercări. Așteaptă {{s}} secunde și reîncearcă.",
    rateLimited: "Prea multe încercări. Așteaptă {{s}} secunde și reîncearcă.",
    emailNotConfirmed: "Confirmă-ți emailul ca să continui. Verifică inbox-ul (și Spam).",
    invalidCredentials: "Email sau parolă incorectă.",
    userAlreadyExists: "Există deja un cont cu acest email. Încearcă autentificarea.",
    weakPassword: "Parolă prea slabă. Folosește minim 8 caractere, litere și cifre.",
    ...
    ageRequired: "Trebuie să-ți verifici vârsta înainte de a continua.",
    signupThrottledIp:
      "Prea multe conturi create de pe această conexiune. Încearcă din nou peste o oră.",
    signupThrottledDevice:
      "Prea multe conturi create de pe acest dispozitiv. Încearcă din nou peste o oră.",
    network: "Conexiune instabilă. Verifică internetul și reîncearcă.",
    unknown: "A apărut o eroare. Te rugăm reîncearcă.",
  },
  cookies: {
    intro:
...
const en: typeof ro = {
  ...
  authErrors: {
    captchaMissing: "Complete the anti-bot check before continuing.",
    captchaFailed: "Anti-bot check failed. Retry in a few seconds.",
    rateLimited_one: "Too many attempts. Wait {{s}} second and try again.",
    rateLimited_other: "Too many attempts. Wait {{s}} seconds and try again.",
    rateLimited: "Too many attempts. Wait {{s}} seconds and try again.",
    emailNotConfirmed: "Confirm your email to continue. Check your inbox (and Spam).",
    invalidCredentials: "Incorrect email or password.",
    userAlreadyExists: "An account with this email already exists. Try signing in.",
    weakPassword: "Password too weak. Use at least 8 characters, letters and digits.",
    emailInvalid: "This email doesn't look valid.",
    disposableEmail:
      "Disposable email not allowed. Use a real address (Gmail, Outlook, Yahoo, ProtonMail or your own domain).",
    ageRequired: "You need to verify your age before continuing.",
    signupThrottledIp:
      "Too many accounts created from this connection. Try again in an hour.",
    signupThrottledDevice:
      "Too many accounts created from this device. Try again in an hour.",
    network: "Unstable connection. Check your internet and retry.",
