...
import { CookiesEn } from "@/components/legal/en/PolicyLegalEn";
...
function CookiesPage() {
  ...
  return (
    <div className="min-h-dvh bg-background">
      <LegalHeader lang={lang} onLang={setLang} ro="Politica de cookie-uri" en="Cookie policy" />
      {lang === "en" ? (
        <CookiesEn rows={COOKIES} onReopen={reopen} />
      ) : (
        <LegalDocOverride
          slug="cookies"
          fallback={
            <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
              ...
              <h2 className="mt-6 text-base font-semibold">
                3. Lista exactă de cookie-uri folosite
              </h2>
              <p className="mt-2">
              ...
              <h2 className="mt-6 text-base font-semibold">4. Cum îți gestionezi consimțământul</h2>
