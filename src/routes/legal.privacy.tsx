...
import { PrivacyEn } from "@/components/legal/en/CoreLegalEn";
import {
  OPERATOR,
  OPERATOR_INTRO,
        ...
        <LegalDocOverride
          ...
          fallback={
            <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5 text-foreground/85">
                ...
                <li>
                  ...
                  <ul className="mt-1 list-[circle] pl-5">
                    <li>
                      <strong>Orientare sexuală / identitate de gen</strong> (gen, orientare,
                      pronume, tribes) — Art. 9(1) date privind viața sexuală.
                    </li>
                    <li>
                      ...
                      un verdict pass/fail. Nu solicităm și nu stocăm document de identitate.
                    </li>
                  </ul>
                ...
                <li>
                  <strong>Locație:</strong> coordonatele rămân pe dispozitivul tău; serverul
                  filtrează prin <em>bucket-uri geografice</em>, nu prin lat/lng. Alți utilizatori
                  văd doar distanță rotunjită ("~500m", "~2km"), niciodată coordonate precise.
                </li>
                ...
                <li>
                  <strong>Tehnice:</strong> IP, tip dispozitiv, OS, identificator de notificări
                  push.
                </li>
                <li>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5 text-foreground/85">
                <li>
                  <strong>Alți utilizatori</strong> — profilul tău public (fotografii, bio,
                  interese).
                </li>
                <li>
                  ...
                  <ul className="mt-1 list-[circle] pl-5">
                    ...
                    <li>
                      ...
                      procesare tranzitorie în UE, imaginea ștearsă imediat, primim doar pass/fail.
                    </li>
              ...
              <p className="mt-2 text-foreground/85">
                Folosim TLS pentru toate conexiunile, Row Level Security pentru izolarea datelor
                între utilizatori, parole hash-uite cu bcrypt, fotografii stocate în bucket-uri
                private cu URL-uri semnate temporar. Moderare AI a fotografiilor înainte de
                publicare.
              </p>

              <h2 className="mt-6 text-base font-semibold">7. Cookies</h2>
              <p className="mt-2 text-foreground/85">
                Folosim doar cookies tehnice esențiale (sesiune autentificare). Nu folosim cookies
                de tracking sau publicitate.
              </p>
