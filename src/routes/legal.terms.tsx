        ...
        fallback={
          <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-foreground/85">
              ...
              <li>
                Postezi conținut sexual explicit, nuditate, minori, violență sau materiale ilegale.
              </li>
            ...
            <p className="mt-2 text-foreground/85">
              Datele privind orientarea sexuală și identitatea de gen sunt tratate ca date sensibile
              sub GDPR (Art. 9) și sunt afișate doar dacă alegi să le completezi. Le poți retrage
            ...
            <p className="mt-2 text-foreground/85">
              ...
              conform legii române (OG 137/2000, Codul Penal Art. 226 — violarea vieții private). Ne
              rezervăm dreptul să cooperăm cu autoritățile la solicitarea victimei.
            </p>
            <p className="mt-2 text-foreground/85">
            ...
            <p className="mt-2 text-foreground/85">
              Funcțiile Premium se achiziționează prin Google Play. Tranzacțiile, taxele și politica
              de refund sunt gestionate de Google conform termenilor săi. Abonamentele se reînnoiesc
              automat până când le anulezi din contul tău Google Play, cel târziu cu 24h înainte de
              sfârșitul perioadei.
            </p>
