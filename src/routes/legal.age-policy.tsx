        ...
        fallback={
          <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-foreground/85">
              ...
              <li>
                Toate fotografiile sunt mutate într-un bucket carantină accesibil doar echipei Trust
                &amp; Safety.
              </li>
              <li>
              ...
              <li>
                Notificăm autoritatea competentă (DIICOT — combatere criminalitate informatică, sau
                poliția locală) când există suspiciune de exploatare.
              </li>
            </ol>
