...
function StatusPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <div
        className={`mb-6 rounded-2xl border p-5 ${overall === "ok" ? "border-emerald-500/30 bg-emerald-500/5" : overall === "degraded" ? "border-amber-500/30 bg-amber-500/5" : "border-destructive/30 bg-destructive/5"}`}
      >
      ...
      <ul className="space-y-2">
        ...
        {loading && checks.length === 0 && (
          <li className="text-sm text-muted-foreground">Se verifică serviciile…</li>
        )}
      </ul>
