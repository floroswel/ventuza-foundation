        ...
        fallback={
          <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
            ...
            <ul className="list-disc pl-5">
              <li>
                <strong>Discriminare și ură</strong> — homofobie, transfobie, rasism, antisemitism,
                islamofobie, capacitism, sexism. Inclusiv în filtrele de profil ("no fats, no fems,
                no asians" = discriminare).
              </li>
              <li>
