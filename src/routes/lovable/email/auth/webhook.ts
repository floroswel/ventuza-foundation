...
// Domeniul verificat și configurat în infrastructura de email.
// Expeditorul trebuie să aparțină exact acestui domeniu; altfel furnizorul
// respinge mesajul cu `no_matching_sender`.
