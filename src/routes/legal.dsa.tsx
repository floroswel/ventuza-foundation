      ...
      <LegalDocOverride
        ...
        fallback={
          <article className="prose prose-invert mx-auto max-w-2xl px-4 py-6 text-sm leading-relaxed">
            ...
            <p>
              Publicăm anual statistici despre: numărul de notificări primite, acțiuni întreprinse,
              conturi suspendate, mediană timp de răspuns. Primul raport va fi publicat la 12 luni
              de la lansarea publică.
            </p>
