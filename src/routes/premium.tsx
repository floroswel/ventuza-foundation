...
import { ChevronLeft, Sparkles, Eye, Zap, Heart, MessageSquare, Plane, BadgeCheck, Megaphone, Gift } from "lucide-react";
...
export const Route = createFileRoute("/premium")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Toate funcțiile Ventuza sunt 100% gratuite pentru utilizatori. Susține-ne prin Ventuza Ads." },
    ],
  }),
      ...
      <div className="mx-auto max-w-md space-y-6 px-4 py-6">
        <section className="rounded-2xl border border-primary/40 bg-gradient-to-br from-primary/15 via-surface to-surface p-5 glow-gold">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Nimic plătit, nicio funcție blocată. Toate uneltele pe care alte aplicații le pun după paywall — la tine sunt
            deschise din prima zi.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-border bg-surface p-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Prin <span className="font-semibold text-foreground">Ventuza Ads</span> — parteneriate cu cluburi, baruri,
            evenimente și branduri LGBTQ-friendly din România. Plătesc ei, tu folosești app-ul gratuit.
          </p>
          <Link
            to="/advertise"
        ...
        <p className="text-center text-[10px] text-muted-foreground">
          Vrei să ne susții personal? Spune-le prietenilor despre Ventuza. Asta contează mai mult decât orice donație.
        </p>
      </div>
