...
BEGIN
  ...
  UPDATE public.profiles
     SET age_status          = v_new_age_status,
         ...
         verified            = CASE WHEN _result = 'pass' THEN true ELSE COALESCE(verified, false) END,
         verified_at         = CASE WHEN _result = 'pass' THEN COALESCE(verified_at, v_now) ELSE verified_at END,
