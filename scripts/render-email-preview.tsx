...
const LINK = 'https://ventuza.app/auth/confirm?token=abc123xyz'
...
<style>
  *{box-sizing:border-box}
  ...
  .tag{display:inline-block;font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:#8a7d6b;margin-bottom:6px}
  .subj{font-family:'Cormorant Garamond',serif;font-size:22px;font-weight:500;margin:0}
  .from{font-size:12px;color:#8a8578;margin-top:6px}
  iframe{width:100%;height:760px;border:0;display:block;background:#fff}
</style></head>
<body><div class="page">
  <div class="head"><h1>VENTUZA</h1><p>Preview emailuri autentificare</p></div>
  <div class="grid">
    ${items.map(it => `<div class="card">
      ...
      <iframe srcdoc="${esc(it.html)}"></iframe>
    </div>`).join('')}
  </div>
</div></body></html>`
