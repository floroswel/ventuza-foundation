...
| ------ | ---------- | ----- |
| `variables.gradle` | `android/variables.gradle` (overwrite) | Forțează `compileSdk=35`, `targetSdk=35`, `minSdk=24` (cerut de pluginul de cameră). Google Play cere targetSdk ≥ 34 de la 31.08.2025. |
